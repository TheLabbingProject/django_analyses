    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "run_method_key",
                    models.CharField(default="run", max_length=100),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="django_analyses.AnalysisVersion",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="specification_set",
                        to="django_analyses.OutputDefinition",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="django_analyses.InputSpecification",
            ),
        ),
        migrations.AddField(
            model_name="analysisversion",
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                related_name="analysis_version_set",
                to="django_analyses.OutputSpecification",
            ),
        ),
        migrations.AddField(
            model_name="analysis",
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="django_analyses.NumberInputDefinition",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="django_analyses.StringInputDefinition",
                    ),
                ),
            ],
            bases=("django_analyses.input",),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="django_analyses.ListOutputDefinition",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="input_set",
                        to="django_analyses.ListInputDefinition",
                    ),
                ),
            ],
            bases=("django_analyses.input",),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="output_set",
                        to="django_analyses.FloatOutputDefinition",
                    ),
                ),
            ],
            bases=("django_analyses.output",),
            ...
            fields=[
                ...
                (
                    ...
                    models.FilePathField(
                        ...
                        max_length=1000,
                        null=True,
                        verbose_name="/media/groot/Data/media",
                    ),
                ),
                (
                    "definition",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="output_set",
                        to="django_analyses.FileOutputDefinition",
                    ),
                ),
            ],
            bases=("django_analyses.output",),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="input_set",
                        to="django_analyses.FileInputDefinition",
                    ),
                ),
            ],
            bases=("django_analyses.input",),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="input_set",
                        to="django_analyses.DirectoryInputDefinition",
                    ),
                ),
            ],
            bases=("django_analyses.input",),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="input_set",
                        to="django_analyses.BooleanInputDefinition",
                    ),
                ),
            ],
            bases=("django_analyses.input",),
        ...
        migrations.AlterUniqueTogether(
            name="analysisversion", unique_together={("analysis", "title")},
        ),
        migrations.CreateModel(
            name="IntegerInput",
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="django_analyses.NumberInput",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="input_set",
                        to="django_analyses.IntegerInputDefinition",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="input_set",
                        to="django_analyses.FloatInputDefinition",
                    ),
                ),
            ],
            bases=("django_analyses.numberinput",),
