    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fixed_run_method_kwargs', django.contrib.postgres.fields.jsonb.JSONField(default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_attribute', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            name='DirectoryInputDefinition',
            fields=[
                ('inputdefinition_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='django_analyses.InputDefinition')),
                ('is_output_directory', models.BooleanField(default=False)),
                ('default', models.FilePathField(allow_files=False, allow_folders=True, blank=True, null=True)),
            ],
            bases=('django_analyses.inputdefinition',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('inputdefinition_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='django_analyses.InputDefinition')),
                ('element_type', models.CharField(choices=[('STR', 'String'), ('INT', 'Integer'), ('FLT', 'Float'), ('BLN', 'Boolean'), ('FIL', 'File')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dynamic_default', models.CharField(blank=True, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_output_definitions', models.ManyToManyField(related_name='specification_set', to='django_analyses.OutputDefinition')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('analysis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_analyses.Analysis')),
                ('base_input_definitions', models.ManyToManyField(related_name='specification_set', to='django_analyses.InputDefinition')),
            ],
            options={
                'ordering': ('-modified', '-created'),
                'get_latest_by': 'modified',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('definition', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='output_set', to='django_analyses.ListOutputDefinition')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('definition', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='output_set', to='django_analyses.FloatOutputDefinition')),
            ],
            bases=('django_analyses.output',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('output_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='django_analyses.Output')),
                ('value', models.FilePathField(blank=True, max_length=1000, null=True, verbose_name='/media/groot/Data/media')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('input_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='django_analyses.Input')),
                ('value', models.FilePathField(allow_files=False, allow_folders=True, max_length=1000, verbose_name='/media/groot/Data/media')),
                ('definition', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='input_set', to='django_analyses.DirectoryInputDefinition')),
            ],
            bases=('django_analyses.input',),
        ),
        migrations.CreateModel(
